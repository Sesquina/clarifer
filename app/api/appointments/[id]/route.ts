...
export async function PATCH(
  ...
  if ("pre_visit_checklist" in body) update.pre_visit_checklist = body.pre_visit_checklist;
  if ("post_visit_notes" in body) update.post_visit_notes = body.post_visit_notes;
  if ("appointment_type" in body) update.appointment_type = body.appointment_type;
